...
public class SendToEsp32 : MonoBehaviour
{
    ...
    public void SendWindData(SerialPortManager spManager, WindManager windManager)
    {
        //SetPortIndices(windManager);
        spManager.WriteToPort(2, windManager.CurrentWindIndex.ToString());
    }

    public void SendSurboData(SerialPortManager spManager, WindManager windManager)
    {
        SetPortIndices(windManager);
